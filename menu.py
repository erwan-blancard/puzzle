...
class MenuState(GameState):
    ...
    def __init__(self):
        super().__init__()
        self.buttons += [
            ButtonLabel("Jouer", 50, 512 / 2 + 60, 100, 48, command=lambda: game_state.set_state(game_state.INGAME)),
            ButtonLabel("Personnaliser...", 512/2+24, 512 / 2 + 64, 220, 40, command=lambda: game_state.set_state(game_state.CUSTOMIZE)),
            ButtonLabel("Scoreboard", 512/2 - 90, 512 / 2 + 148, 180, 48, command=lambda: game_state.set_state(game_state.SCOREBOARD)),
